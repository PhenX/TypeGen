...
namespace TypeGen.Core.Test.Generator.Services
{
    public class TsContentGeneratorTest
    {
        ...
        public static IEnumerable<object[]> GetMemberValueText_Data = new[]
        {
            ...
            new object[] { typeof(GetMemberValueText_TestClass).GetField(nameof(GetMemberValueText_TestClass.DateTimeFieldValue)), false, $@"new Date(""{GetMemberValueText_TestClass.TestDateTime.ToString("o", CultureInfo.InvariantCulture)}"")" },
            new object[] { typeof(GetMemberValueText_TestClass).GetProperty(nameof(GetMemberValueText_TestClass.DateTimePropertyValue)), false, $@"new Date(""{GetMemberValueText_TestClass.TestDateTime.ToString("o", CultureInfo.InvariantCulture)}"")" },
            new object[] { typeof(GetMemberValueText_TestClass).GetField(nameof(GetMemberValueText_TestClass.DateTimeOffsetFieldValue)), false, $@"new Date(""{GetMemberValueText_TestClass.TestDateTimeOffset.ToString("o", CultureInfo.InvariantCulture)}"")" },
            new object[] { typeof(GetMemberValueText_TestClass).GetProperty(nameof(GetMemberValueText_TestClass.DateTimeOffsetPropertyValue)), false, $@"new Date(""{GetMemberValueText_TestClass.TestDateTimeOffset.ToString("o", CultureInfo.InvariantCulture)}"")" },
            ...
            new object[] { typeof(GetMemberValueText_TestClass).GetField(nameof(GetMemberValueText_TestClass.DateTimeFieldValue)), true, $@"""{GetMemberValueText_TestClass.TestDateTime.ToString("o", CultureInfo.InvariantCulture)}""" },
            new object[] { typeof(GetMemberValueText_TestClass).GetProperty(nameof(GetMemberValueText_TestClass.DateTimePropertyValue)), true, $@"""{GetMemberValueText_TestClass.TestDateTime.ToString("o", CultureInfo.InvariantCulture)}""" },
            new object[] { typeof(GetMemberValueText_TestClass).GetField(nameof(GetMemberValueText_TestClass.DateTimeOffsetFieldValue)), true, $@"""{GetMemberValueText_TestClass.TestDateTimeOffset.ToString("o", CultureInfo.InvariantCulture)}""" },
            new object[] { typeof(GetMemberValueText_TestClass).GetProperty(nameof(GetMemberValueText_TestClass.DateTimeOffsetPropertyValue)), true, $@"""{GetMemberValueText_TestClass.TestDateTimeOffset.ToString("o", CultureInfo.InvariantCulture)}""" },
        };
